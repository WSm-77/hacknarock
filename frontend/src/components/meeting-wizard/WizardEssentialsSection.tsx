    ...
    <section>
      ...
      <div className="space-y-6">
        <div>
          ...
          <input className="w-full bg-surface-container-highest border-0 rounded-lg px-4 py-3 text-on-surface focus:ring-2 focus:ring-primary transition-shadow placeholder:text-on-surface-variant/50 font-body" id="meeting-title" name="meeting-title" placeholder="e.g., Q3 Strategy Review" type="text" />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block font-label text-sm font-medium text-on-surface mb-2" htmlFor="duration">Duration</label>
            <div className="relative">
              <select className="w-full bg-surface-container-highest border-0 rounded-lg px-4 py-3 text-on-surface focus:ring-2 focus:ring-primary transition-shadow appearance-none font-body cursor-pointer" defaultValue="60 Minutes" id="duration" name="duration">
        ...
        <div>
          ...
          <textarea className="w-full bg-surface-container-highest border-0 rounded-lg px-4 py-3 text-on-surface focus:ring-2 focus:ring-primary transition-shadow placeholder:text-on-surface-variant/50 font-body resize-none" id="description" name="description" placeholder="Briefly describe the purpose of this gathering..." rows={3} />
        </div>
      </div>
    </section>
  );
